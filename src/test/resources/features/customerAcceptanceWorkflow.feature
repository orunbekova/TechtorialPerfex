  ...
  Scenario: Verify Proposal Acceptance Process
    ...
    * User should see the page title "Apple LLC"
    ...
    Then User should verify that the proposal it was created in TC5 is in the list with
      ...
      | totalPrice   | $300.30                 |
    And User gets the "Constantin_Proposal_Test_TC5" proposal ID from the Proposal# column and save it as proposal_id
    When User clicks on the created proposal "Constantin_Proposal_Test_TC5" from the table
